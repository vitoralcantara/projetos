...
public class CN2Unidade {
	...
	public static void main(String[] args)
	{
		...
		while(true)
		{
			...
			System.out.println("1: Encontrar Raiz de Equacao.");
			System.out.println("2: Resolucao de Sistema Nao-Linear.");
				...
				if(choose == 1)
				{
					...
					funcao:while (true)
					{
						...
						if(choose == 1 || choose == 2 || choose == 3)
						{
							...
							while(true)						
							{
								System.out.println("Escolha um dos metodos de Aproximacao");
								System.out.println("1: Troca de Sinal");
								System.out.println("2: Lagrange");
								System.out.println("3: Voltar ao Menu de Funcoes");
								System.out.println("4: Voltar ao Menu Principal");
								...
								while(true)
								{
									...
									System.out.println("Resultado da execucao do Algoritmo:");
			...
			{
				System.out.println("Você não digitou um número. Reiniciando o programa.");
				continue;
			}
		}
	}
	...
	public void getLagrange()
	{
		...
		if(funcao == FUNCAO_1)
		{
			...
			{
				p.setY(lagrange(2, 0, 2, 1));
				p.setX(1 / lagrange(2, 0, 1, 2));				
			}
			else
			{
				p.setX(- lagrange(2, 0, 2, 1));
				p.setY(-1 / lagrange(2, 0, 1, 2));
			}			
		}
		else if(funcao == FUNCAO_2)
		{
			if(intervalosPositivos)
			{
				p.setY(lagrange(2, 0, 6, 1));
				p.setX(1/lagrange(2, 1, 1, 6));
			}
			else
			{
				p.setX(- lagrange(2, 1, 6, 1));
				p.setY(-1 / lagrange(2, 0, 1, 6));				
			}			
		}
