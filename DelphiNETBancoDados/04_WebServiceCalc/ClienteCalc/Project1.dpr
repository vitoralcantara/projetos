...
{%DelphiDotNetAssemblyCompiler 'c:\arquivos de programas\arquivos comuns\borland shared\bds\shared assemblies\4.0\Borland.Vcl.dll'}
{%DelphiDotNetAssemblyCompiler 'c:\arquivos de programas\arquivos comuns\borland shared\bds\shared assemblies\4.0\Borland.Delphi.dll'}
{%DelphiDotNetAssemblyCompiler 'c:\arquivos de programas\arquivos comuns\borland shared\bds\shared assemblies\4.0\Borland.VclRtl.dll'}
{%DelphiDotNetAssemblyCompiler '$(SystemRoot)\microsoft.net\framework\v1.1.4322\System.Web.Services.dll'}
{%WebRefCreator 'Web References\WebCalc\WebServiceCalc.wsdl'}
{%WebRefCreator 'Web References\WebCalc\WebServiceCalc.map'}
{%WebRefCreator 'Web References\WebCalc\WebServiceCalc.disco'}
...
uses
  ...
  WebCalc.WebServiceCalc in 'Web References\WebCalc\WebCalc.WebServiceCalc.pas';
