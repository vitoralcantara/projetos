...
public class Jogos {
	...
	public Jogos() {
		...
		String resumoBf3 = "Battlefield 3 dá sequência à consagrada franquia shooter da DICE, acrescentando à fórmula tradicional da série novas possibilidades estratégicas, bem como unidades inéditas e um tratamento gráfico diferenciado."
		...
		Requisitos battleReq = new Requisitos(
				"Core 2 Duo ou equivalente (2 núcleos de 2 GHz)",//
				"2 GB",//
