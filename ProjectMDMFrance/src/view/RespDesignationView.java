 ...
 *
 */
public class RespDesignationView extends JFrame{
	...
	public RespDesignationView() {
		...
		JLabel centerLabel = new JLabel("Responsable de :");
		...
		ArrayList<Nature> natures = Install.getAllNatureWithoutResp();
		...
		designTutorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TutorDesignationView view = new TutorDesignationView();
				dispose();
			}
		});
