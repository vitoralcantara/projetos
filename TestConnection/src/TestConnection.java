...
public class TestConnection {
	...
	/**
	 * IMPORTANTISSIMO: Este endereco deve ser configurado caso haja mudança de
	 * servidor. Por exemplo. Se o programa for testado em uma máquina virtual
	 * local, deve-se mudar este endereço para o endereço localhost padrão
	 * android.
	 */
